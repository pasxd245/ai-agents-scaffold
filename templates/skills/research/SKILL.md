---
name: research
description: Use when investigating a topic, comparing options, producing a sourced brief, evaluating tradeoffs, surveying prior art, or gathering current evidence before making a recommendation. Crawls and cites primary sources rather than answering from memory, so reach for it whenever the answer depends on facts that may have changed.
metadata:
  author: a2scaffold
  version: '1.0'
---
